                        ...
                        <div
                            ...
                            <div className='flex items-center cursor-pointer flex-1 min-w-0' onClick={() => {
                                ...
                                <div className='w-20 h-20 sm:w-24 sm:h-24 flex-shirk-0 mr-4'>
                                    {item.product.image && (
                                        <Image src={imageUrl(item.product.image).url()} alt={item.product.name ?? "Product Image"} className="w-full h-full object-cover rounded" width={96}
                                            height={96} />
                            ...
                            <div className='flex items-center ml-4 flex-shrink-0'>
                                <AddToBasketButton product={item.product} disabled={false}></AddToBasketButton>
                            </div>
                        </div>
                    ))}
                </div>
